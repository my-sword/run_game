 ...
 */
public class Sound {
    static final String DIR = "music1/";        // 音乐文件夹
    static final String BACKGROUD = "bg.wav";   // 背景音乐
    static final String JUMP = "jump.wav";      // 跳跃音效
    static final String HIT = "hit.wav";        // 撞击音效
    static final String MONEY = "money.wav";    // 金币音效
